...
import { CheckCircle2, Globe2, Server, Zap, Terminal, Database, Code2, Cpu, Box, Link as LinkIcon } from 'lucide-react';
...
const Home: React.FC = () => {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* 2. Stats Bar & Stack Compatibility */}
        ...
        <div className="container mx-auto max-w-7xl px-4 py-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 border-b border-slate-50 pb-8">
                {[
                    ...
                    { label: 'Domains Indexed', value: '1M+' },
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <span className="text-sm font-semibold text-slate-400 uppercase tracking-widest">Compatible with your stack</span>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="flex flex-col gap-3">
                 ...
                 <div className="flex flex-col gap-3">
                    <Link href="/directory/technology/next.js" className="text-sm text-slate-600 hover:text-blue-600 hover:underline">Sites built with Next.js</Link>
                    <Link href="/directory/technology/next.js" className="text-sm text-slate-600 hover:text-blue-600 hover:underline">Next.js Showcases</Link>
      ...
      <section className="py-20 bg-slate-900 text-white">
          <div className="container mx-auto px-4 text-center max-w-3xl">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to build with SiteJson?</h2>
              <p className="text-slate-400 text-lg mb-8">
                  Get your free API key today. No credit card required. 
                  <br/>Start enriching your data in under 5 minutes.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <Button className="bg-white text-slate-900 hover:bg-slate-100 px-8 h-12 text-base">Get API Key</Button>
                  <Button variant="outline" className="border-slate-700 text-slate-300 hover:bg-slate-800 hover:text-white px-8 h-12 text-base">Contact Sales</Button>
              </div>
          </div>
      </section>
    </div>
